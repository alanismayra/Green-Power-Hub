...
-- -----------------------------------------------------
-- Table `db_Projeto_Integrador`.`tb_temas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_Projeto_Integrador`.`tb_temas` (
  `id` BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `db_Projeto_Integrador`.`tb_postagens` (
  ...
  `postagem` VARCHAR(5000) NOT NULL,
  `data` DATE NOT NULL,
  ...
  CONSTRAINT `fk_tb_postagens_tb_temas1`
    ...
    REFERENCES `db_Projeto_Integrador`.`tb_temas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
