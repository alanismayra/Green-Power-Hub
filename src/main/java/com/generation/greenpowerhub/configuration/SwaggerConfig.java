package com.generation.greenpowerhub.configuration;
...
public class SwaggerConfig {
	...
	@Bean
	OpenAPI springGreenPowerHubOpenAPI() {
		return new OpenAPI()
				.info(new Info()
						.title("Green Power Hub")
						.description("Green Power Hub -- Desenvolvido com a Generation")
						.version("versao0.0.1")
						.license(new License()
